...
* Applications in microbiome research: Visualizing community structure, analyzing diversity, tracking taxonomic abundance
...
* Root (e.g., domain level: Bacteria, Archaea)

* Internal nodes (e.g., phylum, class, order, family, genus)

* Leaf nodes (e.g., species or ASVs/OTUs in microbiome data)
...
* Taxonomic assignments based on reference databases
* Abundance counts at each taxonomic level
* Often incomplete taxonomic resolution at lower levels
...
* BIOM format (Biological Observation Matrix)
